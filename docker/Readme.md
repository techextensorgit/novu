...
Now visit [http://185.100.212.118:4200](http://185.100.212.118:4200) to start using Novu.
...
- `REDIS_TLS={"servername":"185.100.212.118"}`
- `REDIS_CACHE_SERVICE_TLS={"servername":"185.100.212.118"}`
